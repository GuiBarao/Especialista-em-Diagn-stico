...
%Se o usuário possui 80% dos sintomas, o sistema considera a doença como uma possível diagnóstico.

diagnostico(Lista, covid) :-    lista_sintomas(covid, Stm_Covid), %Stm_Covid recebe os sintomas de Covid.
                                percentual(Stm_Covid, 80, Min_sintomas), %Min_sintomas representa a quantidade minima de sintomas para a doença ser considerada.
